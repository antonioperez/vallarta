...
OUT = ROOT / 'las-juntas-concept-06.pdf'
W, H = landscape(A3)
INK = HexColor('#293A36')
...
c.setTitle('Las Juntas | Materials and noise control | Concept 06')
...
def header(sheet, title, subtitle):
    ...
    txt(W-48, H-40, 'CONCEPT 06  /  3 BED + 2 BATH  /  12 SEPTEMBER 2026', 9, MUTED, align='right')
...
def page_appearance():
    ...
    y=top-dh-18
    y=para(48,y,W-96,'Earlier generated style reference, retained for character only. It does not show the adopted heights, new TV/seating, door positions or acoustic assemblies. Perforated screens and slatted gates are decorative; street-noise performance is not established by this image.',8.5,MUTED)-20
    colw=(W-144)/3
