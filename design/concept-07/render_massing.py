...
TMP=Path('/private/tmp/las-juntas-massing'); TMP.mkdir(exist_ok=True)
...
front=Scene((5.4,-7.0,2.3),(5.3,8.0,2.7))
front.face([(0,0,-.07),(10,0,-.07),(10,20,-.07),(0,20,-.07)],'#D4DCC6',-10)
front.face([(0,0,-.065),(10,0,-.065),(10,5.5,-.065),(0,5.5,-.065)],'#D8CBB6',-9)
building(front)
front.box(1.8,.55,0,1.85,4.5,1.4,'#AFB9B6',30)
front.draw('front-massing-guide','FRONT / measured 9 m-wide building and 5.5 m-deep court',[
 'Geometry reference only. Replace grid with open flower-pattern terracotta. Replace boxes with realistic finishes.',
 'Four small exposed front privacy windows; separate stair windows behind the screen. Entry door near center.',
 'Roof cap, sill/head heights and ground level above grade are illustrative.'])
