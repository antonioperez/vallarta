...
OUT = ROOT / 'las-juntas-concept-09.pdf'
W, H = landscape(A3)
INK = HexColor('#293A36')
...
c.setTitle('Las Juntas | Sliding vehicle gate | Concept 09')
...
def header(sheet, title, subtitle):
    ...
    txt(W-48, H-40, 'CONCEPT 09  /  3 BED + 2 BATH  /  12 SEPTEMBER 2026', 9, MUTED, align='right')
...
def page_appearance():
    ...
    y=top-image_size-12
    y=para(48,y,W-96,'Front gate shown fully open: one complete leaf slides right behind the fixed fence, clearing the car exit. Dimensioned plans govern; views are illustrative. Parking gaps are nominal to the boundary before gate hardware. Roof, window and site levels remain to be detailed.',8.5,MUTED,leading=11.5)-15
    colw=(W-120)/2
    ...
    para(48,77,W-96,'Gate operation and its reserved sliding space: page 9. The two-story terracotta screen retains separate stair windows behind it; supports, drainage and cleaning access need detailing. Screens and slats do not establish acoustic performance.',7.4,MUTED,leading=9)
    c.showPage()
