...
OUT = ROOT / 'las-juntas-concept-04.pdf'
W, H = landscape(A3)
INK = HexColor('#293A36')
...
c.setTitle('Las Juntas | Open upstairs bathroom with far-end shower | Concept 04')
...
def header(sheet, title, subtitle):
    ...
    txt(W-48, H-40, 'CONCEPT 04  /  3 BED + 2 BATH  /  12 SEPTEMBER 2026', 9, MUTED, align='right')
...
def page_plans():
    header(1,'A simpler upstairs bathroom.',
    ...
    y=section(x,y,'Upstairs / one open bathroom',width)
    y=para(x,y,width,'The toilet compartment is removed. A walk-in shower occupies the far end opposite the hall door, with the toilet and double vanity in the open dry area. Both bathroom layouts are enlarged on page 2.',9.5)-18
...
def page_appearance():
    ...
    y=top-dh-18
    y=para(48,y,W-96,'Earlier AI-generated style reference, retained for materials and massing only. It has not been regenerated for the interior revisions. Front wet-room openings need privacy glazing; use the revised floor plans for the room arrangement.',8.5,MUTED)-20
    colw=(W-144)/3
